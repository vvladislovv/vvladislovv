...
TOKEN = open("TokenApi.txt", "r").read()
...
def get_date(update, context):
    ...
    cursor.execute("INSERT INTO birthday_reminder (user_id, name, data, reminded) VALUES (?, ?, ?, ?), (user_id, current_name, current_date, 0)")
